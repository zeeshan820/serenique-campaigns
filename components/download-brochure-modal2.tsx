...
export function DownloadBrochureModal2({ children, pdfUrl = "/Treppan-Serenique-Brochure.pdf", headingText = "Download Brochure" }: { children?: React.ReactNode, pdfUrl?: string, headingText?: string }) {
  ...
  const targetId = "hubspot-brochure2-form-container";
